 ...
 */
final class Version20211101044858 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT NOT NULL, cover VARCHAR(255) NOT NULL, publish_year SMALLINT NOT NULL, PRIMARY KEY(id))');
